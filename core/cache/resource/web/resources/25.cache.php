<?php  return array (
  ...
  array (
    ...
    'cacheable' => 1,
    'createdby' => 1,
    'createdon' => 1384724371,
    'editedby' => 1,
    'editedon' => 1385243858,
    'deleted' => 0,
    'deletedon' => 0,
    'deletedby' => 0,
    'publishedon' => 1384722300,
    'publishedby' => 1,
    'menutitle' => '',
    'donthit' => 0,
    'privateweb' => 0,
    ...
    array (
      0 => 'vendors',
      1 => ' john den haan sons nursery || Komrska Tree Farm || garden solutions || duwaynes greenhouse || Northfield Farm || stempky conifer nursery ',
      2 => 'text',
      3 => NULL,
      4 => 'listbox-multiple',
    ),
    ...
    array (
      0 => 'productImage',
      1 => 'images/products/131117_perenials_products.png',
      2 => 'image',
      3 => NULL,
      4 => 'image',
    ),
...
<head>
    ...
    <title>MODX Revolution - perennials</title>
    <base href="[[+site_url]]" />
...
<li class="main_nav_item"><a href="index.php?id=2"><h2>about us</h2></a></li>
</ul><!--main_nav_menu-->
...
<section id="product_about" class="sixteen columns alpha omega">
        <header>
            <h2 class="tagline">growing great relationships</h2>
        </header>
        <header class="page_title"><h2>perennials</h2></header>
<nav class="vendor_product_menu sixteen columns alpha omega"
[[!Wayfinder? 
&startId=`4` 
&ignoreHidden=`0` 
&level=`1` 
&rowTpl=`vendorProductMenuTpl`
&outerTpl=`vendorProductMenuUlTpl`
&rowClass=`vendor_product_menu` 
&hereClass=`here_vendor_product_menu`
&sortBy=`pagetitle`
&sortOrder=`ASC`
]]
</nav><!--vendor_product_menu-->

<p>
          GGS represents vendors for plugs of all sizes, ur/c\'s, ground covers, and finished plants from 1 to 5GL. New introductions, and native suppliers. We have it all!. 
        </p>
...
<section id="products" class="sixteen columns alpha omega">
    	
[[!getResources? &parents=`5` &limit=`0` &tpl=`vendorTpl` &includeContent=`1` &showHidden=`1` &includeTVs=`1` &processTVs=`1` &tvPrefix=`` &tvFilters=`vendorProducts==%perennials%` ]]
        ...
        <article id="about_products" class="eight columns alpha omega">
            <nav id="footer_nav">
                <ul id="footer_nav_list">
                    ...
                    <li><a href="index.php?id=4">plants</a></li>
                    <li><a href="index.php?id=3">services</a></li>
                </ul>
            </nav><!--footer_nav-->
...
<br class="clear">',
    '[[$vendorProductMenu]]' => '<nav class="vendor_product_menu sixteen columns alpha omega"
[[!Wayfinder? 
&startId=`4` 
&ignoreHidden=`0` 
&level=`1` 
...
&sortOrder=`ASC`
    ...
    '[[*introtext]]' => 'GGS represents vendors for plugs of all sizes, ur/c\'s, ground covers, and finished plants from 1 to 5GL. New introductions, and native suppliers. We have it all!. ',
    '[[$productVendorList]]' => '[[!getResources? &parents=`5` &limit=`0` &tpl=`vendorTpl` &includeContent=`1` &showHidden=`1` &includeTVs=`1` &processTVs=`1` &tvPrefix=`` &tvFilters=`vendorProducts==%perennials%` ]]',
    ...
    array (
      ...
      array (
        ...
        array (
          ...
          'name' => 'head',
          'description' => 'the generic <head> of the document',
          'editor_type' => 0,
          'category' => 0,
          'cache_type' => 0,
          'snippet' => '<head>
...
<li class="main_nav_item"><a href="[[~2]]"><h2>about us</h2></a></li>
</ul><!--main_nav_menu-->
...
<br class="clear">',
      ...
      array (
        ...
        array (
          ...
          'source' => 1,
          'property_preprocess' => false,
          'name' => 'vendorProductMenu',
          'description' => '',
          'editor_type' => 0,
          'category' => 2,
          'cache_type' => 0,
          'snippet' => '<nav class="vendor_product_menu sixteen columns alpha omega"
[[!Wayfinder? 
&startId=`4` 
&ignoreHidden=`0` 
&level=`1` 
...
&sortOrder=`ASC`
          ...
          'static' => false,
          'static_file' => '',
          'content' => '<nav class="vendor_product_menu sixteen columns alpha omega"
[[!Wayfinder? 
&startId=`4` 
&ignoreHidden=`0` 
&level=`1` 
...
&sortOrder=`ASC`
      ...
      array (
        ...
        array (
          ...
          'category' => 2,
          'cache_type' => 0,
          'snippet' => '[[!getResources? &parents=`5` &limit=`0` &tpl=`vendorTpl` &includeContent=`1` &showHidden=`1` &includeTVs=`1` &processTVs=`1` &tvPrefix=`` &tvFilters=`vendorProducts==%[[*pagetitle]]%` ]]',
          'locked' => false,
          'properties' => 
          array (
          ),
          'static' => false,
          'static_file' => '',
          'content' => '[[!getResources? &parents=`5` &limit=`0` &tpl=`vendorTpl` &includeContent=`1` &showHidden=`1` &includeTVs=`1` &processTVs=`1` &tvPrefix=`` &tvFilters=`vendorProducts==%[[*pagetitle]]%` ]]',
        ),
        'policies' => 
        array (
        ),
      ...
      array (
        ...
        array (
          ...
          'property_preprocess' => false,
          'name' => 'footer',
          'description' => 'generic <footer> chunk',
          'editor_type' => 0,
          'category' => 0,
          'cache_type' => 0,
