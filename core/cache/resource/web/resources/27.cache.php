<?php  return array (
  ...
  array (
    ...
    array (
      0 => 'vendors',
      1 => ' duwaynes greenhouse || black lake nursery ',
      2 => 'text',
      3 => NULL,
      4 => 'listbox-multiple',
    ),
    ...
    array (
      0 => 'productImage',
      1 => 'images/products/131117_annuals_products.png',
      2 => 'image',
      3 => NULL,
      4 => 'image',
    ),
...
<head>
    ...
    <title>MODX Revolution - annuals</title>
    <base href="[[+site_url]]" />
...
<section id="product_about" class="sixteen columns alpha omega">
        ...
        <header class="page_title"><h2>annuals</h2></header>
...
<p>
          We offer annual liners, unrooted cuttings and prefinished plants from the best genetics and producers around the world. If it is available, we can source it!
        </p>
...
[[!getResources? &parents=`5` &limit=`0` &tpl=`vendorTpl` &includeContent=`1` &showHidden=`1` &includeTVs=`1` &processTVs=`1` &tvPrefix=`` &tvFilters=`vendorProducts==%annuals%` ]]
...
&sortOrder=`ASC`
    ...
    '[[*introtext]]' => 'We offer annual liners, unrooted cuttings and prefinished plants from the best genetics and producers around the world. If it is available, we can source it!',
    '[[$productVendorList]]' => '[[!getResources? &parents=`5` &limit=`0` &tpl=`vendorTpl` &includeContent=`1` &showHidden=`1` &includeTVs=`1` &processTVs=`1` &tvPrefix=`` &tvFilters=`vendorProducts==%annuals%` ]]',
